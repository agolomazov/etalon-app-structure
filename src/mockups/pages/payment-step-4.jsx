      ...
      <L.Div className="page-content padding-x-32 padding-y-16 border-top">
        ...
        <L.Div className="toolbar padding-x-32 margin-top-auto margin-x-32-negative txt-right">
          <L.Button
            ...
            onClick={() => history.push('/contracts-list/contract-item/contract-payment/payment-step-3')}
          >
            Назад
          </L.Button>
          <L.Button
            className="margin-left-24 success"
            onClick={() => history.push('/contracts-list/contract-item/contract-payment/payment-step-5')}
          >
            Далее
          </L.Button>
        </L.Div>
