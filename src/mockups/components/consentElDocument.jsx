          ...
          <L.Div className="modal-scroll">
            <L.Div className="modal-scroll-content">
              ...
              <L.P>
                ...
                «Я принимаю условия Согласия на получение юридически значимых
                сообщений электронным способом доставки в Личный кабинет
                Арендатора», Я, <strong>Кохан Александр Иванович</strong>,
                действующий от имени <strong>ООО «Мир ФМ»</strong>,{' '}
                <strong>ИНН 3328420555</strong>, (далее по тексту – Арендатор)
                даю согласие на изменение способа доставки всех юридически
                значимых сообщений (документов), связанных с исполнением
                договоров аренды, заключенных между Росимуществом
                (территориальными органами Росимущества) и Арендатором в
                отношении федерального имущества, в том числе земельных
                участков, на электронный способ доставки в Личный кабинет
                Арендатора.
              </L.P>
            </L.Div>
