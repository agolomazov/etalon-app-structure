        ...
        <L.Div className="window-content">
          ...
          <L.Div className="modal-scroll">
            <L.Div className="border-bottom margin-bottom-16 padding-bottom-24">
              <L.Div className="txt-gray padding-bottom-8">
                20.02.2020 в 20:20
              </L.Div>
              <L.H6 className="padding-bottom-8">
                Уведомление об изменении арендной платы
              </L.H6>
              <L.P>Со второго квартала 2020 года будет изменены условия.</L.P>
              <L.Div className="inner secondary flex-row justify-content-between align-items-center padding-x-16 padding-y-12">
                <L.Div>
            ...
            <L.Div>
              ...
              <L.H6 className="padding-bottom-8">
                Уведомление об изменении реквизитов для оплаты
              </L.H6>
              <L.P>
                Реквизиты для оплаты были изменены. Просьба учесть в работе.
              </L.P>
              <L.Div className="inner secondary flex-row justify-content-between align-items-center padding-x-16 padding-y-12">
                <L.Div>
                  <L.I className="novicon-doc-list margin-right-12 txt-gray" />
