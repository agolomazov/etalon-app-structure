...
import { PaymentMissed } from '@features/situations';
import { selectors as contractsSelectors } from '@features/contracts';

/**
 * ## Страница ЖС "Отсутствует платеж по договору аренды"
 *
 * @example
 * <SituationPaymentMissedPage />
 *
 * @returns {React$Node} Страница ЖС "Отсутствует платеж по договору аренды"
 */
export const SituationPaymentMissedPage = () => {
        ...
        <SubHeader>
          <Link
            ...
            className="novicon-arrow-backward
                       backward-link txt-gray margin-right-12"
          />
